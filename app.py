...
selected_asset_name = st.sidebar.selectbox("1. Numerator", list(st.session_state.asset_dict.keys()), index=1) # Default: Nifty 50
benchmark_name = st.sidebar.selectbox("2. Denominator", list(st.session_state.asset_dict.keys()), index=0) # Default: Broad Market 500
